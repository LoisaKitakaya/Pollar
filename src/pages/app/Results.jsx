...
import jupyterLogo from "../../assets/jupyter_app_icon.png";
    ...
    <div className="h-full py-4 px-20 bg-zinc-100 min-h-screen">
      ...
      <div className="flex justify-evenly">
        <div className="flex flex-col">
          ...
          <button className="rounded-md shadow-md px-2 bg-orange-300 hover:bg-orange-400 mx-2 mt-4 flex items-center justify-center hover:shadow-lg">
            <img src={jupyterLogo} alt="logo" className="h-3/4" />
