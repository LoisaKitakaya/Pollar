...
import CandidateAvatar from "../../Organizer-console/Candidate-modals/CandidateAvatar";

const PollView = ({ openedPoll, setOpenedPoll, pollData }) => {
  const theme = useMantineTheme();

  const candidates = pollData.candidateSet;
